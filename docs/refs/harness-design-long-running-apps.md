...
*This article is about multi-agent harness design for AI coding agents, featuring a Planner-Generator-Evaluator architecture inspired by GANs. Key topics: context resets vs compaction, self-evaluation problems, GAN-inspired generator-evaluator loops, sprint contracts, and iterative harness simplification as models improve.*
